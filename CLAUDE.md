...
- **sync.test.ts** -- Review task sync: branch merged+deleted promotes to done, branch merged but exists promotes to done, unmerged branch stays review, null branch skipped, no review tasks returns 0, worktree field cleared on promotion (best-effort removeWorktree + null update), no-worktree task promotes normally
