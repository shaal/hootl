...
src/
  ...
  selection.ts        Dependency-aware task selection: getNextTask (consolidated entry point), sortByStrategy (effort-based tiebreaking within priority tiers), findRunnableTask, topoSortTasks (Kahn's algorithm topological sort for goal prioritization)
