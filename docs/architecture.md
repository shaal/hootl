...
proposed --> ready --> in_progress --> review --> done
                          ...
                          |    |
                          |    +--> done/review (auto-promote: all deps done + confidence > 0 + no branch diff)
                          |
